...
def brand_art(p, context, decorative=False):
 ...
 label='' if decorative or kind=='icon' else p.get('logoLabel',p['name'])
...
def resume():
 body='''<section class="case-hero"><a class="back-link" href="index.html">← Home</a><p class="eyebrow">Background & experience</p><h1>A builder, across<br><em>disciplines.</em></h1><p class="case-deck">AI applications, business workflows and the engineering that brings them together.</p></section><section class="background-grid"><div><p class="eyebrow">Experience</p><article class="role"><span>MANIFOLD ENGINEERING</span><h2>Founder & Software Engineer</h2><p>AI development studio. Client software across lending, workplace services, structural engineering and commercial real estate, alongside internal developer tools and research prototypes.</p><a href="index.html#work">Explore the projects ↗</a></article><article class="role"><span>FIFTYFLOWERS</span><h2>AI Solutions Engineer</h2><p>AI applications across customer support, marketing, company knowledge, commerce and product-data operations. Earlier work as AI & Process Innovation Associate established several of the storefront integrations.</p><a href="fiftyflowers.html">Explore FiftyFlowers ↗</a></article><article class="role"><span>WEBMARKETS / 2024 INTERNSHIP</span><h2>Web Developer Intern</h2><p>Independently built WebMarkets’ first client portal in two weeks. Contributed frontend and backend features to ALPHA SEO with the engineering team.</p><a href="client-portal.html">Explore the Client Portal ↗</a></article><article class="role"><span>EDUCATION</span><h2>Computer Science, B.S.</h2><p>Arizona State University · May 2025</p></article></div><aside class="document-panel"><p class="eyebrow">Documents</p><h2>The full background.</h2><p>The live LinkedIn profile reflects the September 2026 experience update. The résumé retains its May 2025 experience content and does not yet include the newer work. Its public contact details were updated in September 2026.</p><a class="button dark" href="https://www.linkedin.com/in/baylor-harrison">Current LinkedIn profile ↗</a><a class="document-link" href="files/Baylor-Harrison-Resume.pdf" download>Résumé <span>PDF · May 2025 ↓</span></a><a class="document-link" href="files/Baylor-Harrison-LOR.pdf" download>Recommendation <span>PDF ↓</span></a><details><summary>View document previews</summary><a href="images/SeniorResume.png"><img src="images/SeniorResume.png" alt="Résumé with May 2025 experience and updated contact email" loading="lazy"></a><a href="images/LOR.png"><img src="images/LOR.png" alt="Existing letter of recommendation" loading="lazy"></a></details></aside></section>'''
