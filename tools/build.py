...
def visual(p,large=False,layered=False):
 ...
 if v=='flowers':
  ...
  inner='<span class="visual-kicker">TILL / LENDING INTELLIGENCE</span><div class="score-orbit" aria-hidden="true"><span></span><span></span><span></span><b>till.</b></div><div class="visual-bottom"><span>Applications → Scoring → Insight</span><strong>$24k<small>annual savings</small></strong></div>'
 elif v=='platform':
...
def resume():
 from career import career_page
 return page('Background & experience','Baylor Harrison: founder of Manifold Engineering, AI Solutions Engineer and ASU Computer Science graduate. Explore the career timeline and current résumé.',career_page(PROJECTS,brand_art),'resume.html','resume')
...
build_clean_routes(ROOT, ["index", "resume"] + [p["id"] for p in PROJECTS], SITE)
