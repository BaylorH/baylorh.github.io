...
def visual(p,large=False):
 if p.get('image'):
  return f'<div class="project-visual {p["color"]} image-visual"><img src="{p["image"]}" alt="{e(p["name"])} — original project screen" loading="lazy" width="1200" height="800"></div>'
