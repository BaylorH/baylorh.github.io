...
for name in ['assets/css/portfolio.css','assets/css/refinement.css','assets/js/portfolio.js','assets/js/analytics.js','assets/js/motion.js','assets/js/motion-license.txt']:
