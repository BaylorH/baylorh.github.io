...
for directory in ['images','videos','files','resume']+[p['id'] for p in json.loads((root/'content/projects.json').read_text())]:shutil.copytree(root/directory,out/directory,ignore=shutil.ignore_patterns('.DS_Store'))
